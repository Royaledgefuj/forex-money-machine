...
// Billing Plan in PayPal LIVE (real money) using the local PAYPAL_CLIENT_ID/
// SECRET. Run once, then put the printed plan ID into
// PAYPAL_MEMBERSHIP_PLAN_ID in Railway. Mirrors setup-paypal-membership.js
// exactly except for the guard — kept as a separate file so the sandbox
// script can never accidentally run against live, or vice versa.
